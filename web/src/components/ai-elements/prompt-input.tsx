...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    Promise.all(
      ...
      .catch(() => {
        // Keep attachments on conversion failure so the user can retry
      })
  }
  ...
  useEffect(() => {
    if (
      ...
      speechRecognition.onresult = (event) => {
        ...
        // SpeechRecognitionResultList has no Symbol.iterator in the TS DOM lib,
        // so Array.from (array-like conversion) is required here.
