...
// NOTE: 上游 rc.20 曾新增 TestStreamScannerHandler_ClientCancelAbortsUpstreamAndReturns,
// 断言客户端断连后立即中止上游读取. 本项目采用相反策略 (见 ba89cd6c / stream_scanner.go):
// 客户端断连后继续读完上游流, 以拿到最后的 usage 事件保证计费完整. 该测试与本决策矛盾, 已移除.
